...
| Name | Version |
|------|------:|
| <a href="https://github.com/terraform-aws-modules/terraform-aws-ecs" target="_blank">terraform-aws-modules/ecs/aws</a> | 7.5.0 |
...
| cluster_capacity_providers                        | List of capacity provider names to associate with the ECS cluster.                                                                                                           | `list`   | `["FARGATE", "FARGATE_SPOT"]`                                                                                                                                        | no       |
